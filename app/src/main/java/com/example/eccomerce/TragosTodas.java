...
public class TragosTodas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Asocia el layout
        setContentView(R.layout.activity_tragos_todas);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mainTragos), (v, insets) -> {
